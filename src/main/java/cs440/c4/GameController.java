...
public class GameController {
	 ...
	 * @param maxCols
	 */
	public GameController(int maxRows, int maxCols) {
	...
	public void userPlay( int col) {
        ...
        int r = gb.addDisk(col, GameBoard.USER);
	...
	/**
	 * Looks to see if the game conlumn is full.
	 */
	public boolean isColumnFull(int c) {
		return gb.isColumnFull(c);
	}
}
